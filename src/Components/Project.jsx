...
const Project = ({image, title, liveLink, gitLink}) => {
  ...
  return (
    <div className="w-full h-[350px] sm:h-[400px] lg:h-[450px] overflow-hidden relative rounded-xl group">
          <img className="relative top-0 left-0 w-full h-auto transition-transform duration-1000 ease-in-out transform lg:group-hover:-translate-y-[calc(100%-450px)] sm:group-hover:-translate-y-[calc(100%-400px)] group-hover:-translate-y-[calc(100%-350px)]" src={image} alt="" />
